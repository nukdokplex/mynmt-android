package ru.nukdotcom.mynmt.radio.player;
...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY =  "ru.nukdotcom.mynmt.ACTION_PLAY";
    public static final String ACTION_PAUSE = "ru.nukdotcom.mynmt.ACTION_PAUSE";
    public static final String ACTION_STOP =  "ru.nukdotcom.mynmt.ACTION_STOP";
